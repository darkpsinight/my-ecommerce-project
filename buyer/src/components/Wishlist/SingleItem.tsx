...
import { removeItemFromWishlistAsync, selectWishlistLoading } from "@/redux/features/wishlist-slice";
    ...
    <div className="flex items-center border-t border-gray-3 py-5 px-10">
      <div className="min-w-[83px]">
        <button
          ...
          className="flex items-center justify-center rounded-lg max-w-[38px] w-full h-9.5 bg-gray-2 border border-gray-3 ease-out duration-200 hover:bg-red-light-6 hover:border-red-light-4 hover:text-red disabled:cursor-not-allowed disabled:opacity-70"
        >
          {isWishlistLoading ? (
