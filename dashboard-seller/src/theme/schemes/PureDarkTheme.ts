...
const colors = {
  ...
  layout: {
    ...
    sidebar: {
      ...
      menuItemHeadingColor: darken(themeColors.white, 0.3)
    }
  }
};
...
export const PureDarkTheme = createTheme({
  ...
  colors: {
    ...
    alpha: {
      white: {
        5: colors.alpha.white[5],
        10: colors.alpha.white[10],
        30: colors.alpha.white[30],
        50: colors.alpha.white[50],
        70: colors.alpha.white[70],
      ...
      black: {
        5: colors.alpha.black[5],
        10: colors.alpha.black[10],
        30: colors.alpha.black[30],
        50: colors.alpha.black[50],
        70: colors.alpha.black[70],
  ...
  header: {
    ...
    textColor: colors.alpha.white[70]
  },
  spacing: 9,
  palette: {
    common: {
