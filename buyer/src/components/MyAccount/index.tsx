      ...
      <PageContainer fullWidth={true}>
        <section className="overflow-hidden pt-[95px] py-20 bg-gray-2">
                  ...
                  <div className="flex flex-wrap xl:flex-nowrap xl:flex-col gap-4">
                    ...
                    >
                      ...
                      >
                        ...
                        />
                        <path
                          d="M15.125 8.1875C15.4702 8.1875 15.75 8.46732 15.75 8.8125V10.6875C15.75 11.0327 15.4702 11.3125 15.125 11.3125C14.7798 11.3125 14.5 11.0327 14.5 10.6875V10.0625H13.875C13.5298 10.0625 13.25 9.78268 13.25 9.4375C13.25 9.09232 13.5298 8.8125 13.875 8.8125H15.125C15.125 8.46732 15.4048 8.1875 15.125 8.1875Z"
                          fill=""
                        />
                      </svg>
                      My Codes
          ...
          <!--== user dashboard content start ==--> */}
            ...
            <div
              className={`flex-1 bg-white rounded-xl shadow-1 py-9.5 px-4 sm:px-7.5 xl:px-10 ${
          ...
          <!-- orders tab content start --> */}
            <div
              className={`flex-1 bg-white rounded-xl shadow-1 ${
