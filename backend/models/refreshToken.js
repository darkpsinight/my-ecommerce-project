...
const isProduction = configs.ENVIRONMENT === keywords.PRODUCTION_ENV;
...
const getRefreshTokenOptns = () => {
  return {
    ...
    signed: true, // Optional: Ensure proper key management
    sameSite: isProduction ? "strict" : "lax", // Default to strict
