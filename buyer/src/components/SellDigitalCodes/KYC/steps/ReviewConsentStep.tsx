...
const ReviewConsentStep = ({ formData, handleInputChange }: StepProps) => {
  return (
    <div className="space-y-6">
      <h2 className="text-xl font-semibold text-gray-900">Review & Consent</h2>
        ...
        <div className="border-t border-gray-200">
          <dl>
            ...
            <div className="bg-gray-50 px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
              ...
              <dd className="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">{formData.idType}</dd>
            </div>
            <div className="bg-white px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
              <dt className="text-sm font-medium text-gray-500">ID Number</dt>
              <dd className="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">{formData.idNumber}</dd>
            </div>
          </dl>
        </div>
      </div>
      ...
      <div className="space-y-4">
        ...
        <div className="relative flex items-start">
          ...
          <div className="ml-3 text-sm">
            <label htmlFor="accuracyConsent" className="font-medium text-gray-700">
